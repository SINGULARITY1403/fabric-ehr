...
const {Gateway, Wallets} = require('../../server/node_modules/fabric-network');
const FabricCAServices = require('../../server/node_modules/fabric-ca-client');
...
const walletPath = '/home/human/Work/EHR/app/patient-asset-transfer/application-javascript/wallet';
...
exports.connectToNetwork = async function(doctorID) {
  ...
  try {
    const walletPath = '/home/human/Work/EHR/patient-asset-transfer/application-javascript/wallet';
